...
```
> **说明**：上述目录结构中的粗体文件op_host/add_custom_tiling.h、op_host/add_custom.cpp、op_kernel/add_custom.cpp为后续算子开发过程中需要修改的文件，其他文件无需修改。也可以参考本仓中其他样例算子目录，如 ops/ascendc/src/slice_gelu_custom工程。
...
样例参考本仓 ops/ascendc/AddKernelInvocation/ 目录使用
```shell
